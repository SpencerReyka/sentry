...
class SentryAppsBaseEndpoint(Endpoint):
    ...
    def convert_args(self, request, *args, **kwargs):
        # Only the POST endpoint includes an Organization.
...
class SentryAppAuthorizationPermission(SentryPermission):
    def has_object_permission(self, request, view, installation):
        self.determine_access(request, installation.organization)
...
class SentryAppAuthorizationBaseEndpoint(SentryAppInstallationBaseEndpoint):
